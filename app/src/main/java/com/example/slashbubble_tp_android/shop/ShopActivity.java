...
public class ShopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Card(App.getAppResources().getString(R.string.default_package), R.drawable.round_violet, R.drawable.round_blue, R.drawable.round_green));
        items.add(new Card(App.getAppResources().getString(R.string.stone_package), R.drawable.stone_pink, R.drawable.stone_blue,R.drawable.stone_yellow));
